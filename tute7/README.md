...
Once you have completed these, there are three optional exercises in
`src/supplementary/` for extra practice. These are not assessed.

- `src/supplementary/BinTree.hs`
- `src/supplementary/BinTreeParser.hs`
- `src/supplementary/RockPaperScissors.hs`
