...
module Applicative (Applicative(..), (<$>), fmap, nestedApply) where
...
-- | Takes functions in an Applicative of Applicatives, and values in the same inner Applicative context
--   and applies the functions to the values
--
